<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ url('/') }}">
                        <!-- Adjusted Logo Size -->
                        <x-application-logo class="block w-auto fill-current text-black" style="height: 54px;" />
                    </a>
                </div>
            </div>
    ...
    @auth
            ...
            <div class="flex items-center ml-8 space-x-8">
                <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="text-lg font-bold text-black">
                    {{ __('Dashboard') }}
                </x-nav-link>
                <x-nav-link :href="route('products.index')" :active="request()->routeIs('products.index')" class="text-lg font-bold text-black">
                    {{ __('Admin Dashboard') }}
                </x-nav-link>
            </div>
